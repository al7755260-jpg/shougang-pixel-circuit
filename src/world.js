...
export function createWorld(renderer,track) {
  ...
  function update(time,robotState){props.animate(time);city.animate(time);skyTraffic.animate(time);robot.update(robotState,time);
  ...
  return {scene,road,sun,reflection,loadEnvironment,update,updateOcclusion,prepareRender,
